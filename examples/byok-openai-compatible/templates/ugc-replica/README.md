...
| `seedance` + `speaker-v1` 多 Take | `@hypit/minimax-h3-kits` + 多 Segment `h3:ReferenceVideo` Take |
...
<h3:ReferenceVideo id="shot-take" prompt={shot-prompt}
  duration="8" resolution="768P" aspect-ratio="9:16">
